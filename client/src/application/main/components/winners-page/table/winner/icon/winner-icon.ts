import './winner-icon.scss';

import { DOMElement } from '../../../../../../shared/components/base-elements/dom-element';

export class WinnerIcon extends DOMElement {
  constructor(parentNode: HTMLElement, color = '#000') {
    super(parentNode, {
      tagName: 'div',
      classList: ['winner-icon'],
    });

    this.node.innerHTML = `<svg class="winner-icon__svg" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
